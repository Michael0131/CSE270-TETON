...
class TestSmokeTest():
  ...
  def test_joinPageTest(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Hall")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Ramen House")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Ramen Cooker")
  ...
  def test_adminPageTest(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("dasdasdawadsdwaadswadsdwaasdwadawasdwadawdasdwadwad")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("awdwadawdasdawdasdwasddwadasdwadsadawdasdwadasdwasdwadasdawdad")
